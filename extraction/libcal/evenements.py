...
#    champs = ["id", "title", "start", "location.id", "location.name", "audience.id", "audience.name", "owner.id", "owner.name", "presenter"]
...
if __name__ == "__main__":
    ...
    if access_token:
        ...
        resultats = paginer_api(url_api + "/events", access_token, params_page, args.taille_page)
