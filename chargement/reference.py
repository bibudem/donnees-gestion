...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Script pour charger les transactions de référence dans l\'entrepôt')
...
initialisation_logs()
logger = logging.getLogger("chargement/reference.py")
